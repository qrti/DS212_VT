...
// Function void Ctrl(AiRANGE/BiRANGE, DC+LV+ACT) in Val Defined channel characteristics description    // qqq exchanged AC <-> DC
//======+==================+========================+=======================+
// Val: |  AC/DC coupling  | Low/high voltage range | Grounding/activation  |
//------+------------------+------------------------+-----------------------+
enum    { DC=0x00, AC=0x02,  LV=0x00, HV=0x01,        GND=0x00, ACT=0x04, };        
//======+==================+========================+=======================+
